  ...
  return (
    <>
      <nav className={style.appbar}>
        ...
        <button onClick={toggleSettings} className={style.settings}>
          <img width={36} src="/icons/settings.svg" alt="settings" />
        </button>
      </nav>

      <InfoModal open={settings} onClose={toggleSettings}>
        <div className={style.appSettings}>
          <h4 className={style.settings_title}>настройки</h4>

          <div className={style.settings_sound}>
            <Toggle onClick={toggleSound} isActive={sound} />
            <p>звук</p>
          </div>

          <div className={style.settings_premium}>
            {premiumStatus == "active" ? (
              ...
              <>
                <p>
                  <span> доступно только</span> <br />с премиум подпиской
                </p>

                <button
                  onClick={() => navigate("/premium")}
                  className={style.premium_btn}
                >
                  <img width={22} src="/icons/corona.svg" alt="premium" />
                  активировать
                </button>
              </>
            )}
            ...
            <div className={style.hints}>
              <Toggle
                onClick={premiumStatus == "active" ? toggleHits : () => {}}
                isActive={hits}
              />
              <p>подсказки</p>
            </div>
